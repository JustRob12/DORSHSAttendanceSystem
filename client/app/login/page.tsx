          ...
          <div style={{ position: "relative", zIndex: 1, textAlign: "center" }}>
            ...
            <div style={{ marginTop: "2.5rem", display: "flex", flexDirection: "column", gap: "0.75rem", textAlign: "left" }}>
              {[
                ...
                { icon: "✓", text: "Automated records & reports" },
              ].map((item, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: "0.625rem" }}>
                  <span style={{ width: 20, height: 20, borderRadius: "50%", background: "rgba(255,255,255,0.15)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "0.7rem", color: "#86efac", flexShrink: 0 }}>
                    {item.icon}
                  </span>
                  <span style={{ fontSize: "0.8125rem", color: "rgba(255,255,255,0.75)" }}>{item.text}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div style={{ flex: 1, padding: "2.5rem", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          <div className="flex md:hidden" style={{ alignItems: "center", gap: "0.75rem", marginBottom: "1.5rem", paddingBottom: "1.25rem", borderBottom: "1px solid #e5e5e5" }}>
            <div style={{ width: 40, height: 40 }}>
              <Image src="/images/logo/DORSHS.png" alt="DORSHS Logo" width={40} height={40} style={{ borderRadius: "8px" }} priority />
            </div>
            <div>
          ...
          <div style={{ marginBottom: "1.5rem" }}>
            ...
            <p style={{ fontSize: "0.8125rem", color: "#737373", marginTop: "3px" }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            <div>
              ...
              <input id="email" type="email" className="sc-input" placeholder="you@dorshs.edu.ph" required />
            </div>
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                <input id="password" type={showPassword ? "text" : "password"} className="sc-input" placeholder="••••••••" required style={{ paddingRight: "3rem" }} />
